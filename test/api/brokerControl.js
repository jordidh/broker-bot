    ...
    it('calculates STOCH successfully', async () => {
        ...
        var expected = {
            ...
            "result" : [
                ...
                [ 1552055510000, 0 ],
                [ 1552055520000, 0 ],
                [ 1552055530000, 44.45688489735633 ],
                [ 1552055540000, 36.33726975847474 ],
                [ 1552055550000, 47.578845602576564 ],
                [ 1552055560000, 53.19963352462748 ],
                [ 1552055570000, 47.578845602576564 ],
                [ 1552055580000, 47.578845602576564 ],
                [ 1552055590000, 53.19963352462748 ],
                [ 1552055600000, 41.95805768052565 ],
                [ 1552055610000, 47.578845602576564 ],
                [ 1552055620000, 53.19963352462748 ],
                [ 1552055630000, 53.19963352462748 ]
            ]
        };

        let result = await brokerControl.applyIndicator(prices, "STOCH", 14, 0, 3);
